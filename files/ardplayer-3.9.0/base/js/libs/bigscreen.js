...
(function(root, document, iframe) {
    ...
    var bigscreen = {
        ...
        exit: function() {
            ...
            // Fix for mobile video element html5 video api
            typeof bigscreen.element[fn.exit] == 'function' && bigscreen.element[fn.exit]();
            typeof document[fn.exit] == 'function' && document[fn.exit]();
        },
